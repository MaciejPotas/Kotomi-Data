"""Kivy presentation for the Availability quiz.

All settings, generation, filtering, statistics, and session behavior comes
from :mod:`logic`. This module owns only mobile rendering and interaction.
"""
